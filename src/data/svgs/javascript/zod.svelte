...
<svg class={className} {width} {height} viewBox="0 0 256 203"
	><defs
		><filter
			id="zod_b"
			width="105.2%"
			...
			><feOffset dx="1" dy="1" in="SourceAlpha" result="shadowOffsetOuter1" /><feGaussianBlur
	...
	/><g transform="translate(2 1.51)"
		><use xlink:href="#zod_a" filter="url(#zod_b)" /><use xlink:href="#zod_a" fill="#3068B7" /></g
	></svg
>
